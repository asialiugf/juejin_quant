...
# common event
print('befor _g_ev_timer = Event()' )
_g_ev_timer = Event()

# market data event
print('befor _g_ev_md_login = Event()' )
...
def _on_md_bar1_cb(bar):
    _g_ev_md_bar1.fire(bar)

def _on_md_bar2_cb(bar):
    _g_ev_md_bar2.fire(bar)

def _on_md_bar3_cb(bar):
    _g_ev_md_bar3.fire(bar)
...
print('befor gm_set_timer_callback(_on_timer_cb)')
...
print('befor gm_md_set_bar_callback(_on_md_bar_cb)')
...
class MdApi(object):
    def __init__(self):
        ...
        self.ev_bar1 = _g_ev_md_bar1
        self.ev_bar2 = _g_ev_md_bar2
        self.ev_bar3 = _g_ev_md_bar3
        '''
        added by charmi
        '''
...
class StrategyBase(object):
    def __init__(self,
        ...
        self.md.ev_bar += self.on_bar1
        self.md.ev_bar += self.on_bar2
        self.md.ev_bar += self.on_bar3
